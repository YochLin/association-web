        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p class="text-gray-600 mb-6 leading-relaxed">
              我們的協會致力於促進行業發展、提供專業支持並創建一個互相學習與合作的社區。我們將各行各業的領導者、創新者和實踐者聚集在一起，共同探討行業趨勢、分享最佳實踐並解決共同挑戰。
            </p>
            <p class="text-gray-600 mb-8 leading-relaxed">
              作為行業的引領者，我們組織各種活動、研討會和培訓課程，為會員提供持續學習和專業發展的機會。通過我們的網絡和資源，會員可以建立有價值的聯繫，推動事業發展。
            </p>
